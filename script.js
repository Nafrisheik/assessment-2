var x='obituaries';
const urlData= fetch('https://api.nytimes.com/svc/topstories/v2/'+x+'.json?api-key=SUU6MbBAiu7yoWDIuu7XrsXVuCizdv4L');
urlData.then((value)=>{
     return value.json();
})
     .then((data)=>{
          ...
          document.getElementById("articleInline").src=data.results[0].multimedia[4].url;
